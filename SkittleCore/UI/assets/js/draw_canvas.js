...
var drawGraph = function (graph, offset, chunks) {
    switch (graph) {
        case "a":
            return drawAnnotations(offset, chunks)
        case "b":
            return drawNucBias(offset, chunks);
        case "m":
            return drawRMap(offset, chunks);
        case "s":
            return drawSimHeat(offset, chunks);
        case "r":
            return drawRepeatOverview(offset, chunks);
        default:
...
var drawAnnotations = function (offset, chunks) {
    ...
    visibleAnnotations.sort(function (a, b) {
        return annotations[a]["Start"] - annotations[b]["Start"] + (annotations[b]["End"] / annotations[b]["Start"] - annotations[a]["End"] / annotations[a]["Start"])
    })
