...
def calculateOutputPixels(state, threeMerState=ThreeMerDetectorState()):
    ...
    maximum = (2.4676524055 * state.nucleotidesPerLine() ** (
        -0.5070724543)) * 2#x2 low Pass Filter: this equation is based on the 95th Percentile of the low pass filtered data
