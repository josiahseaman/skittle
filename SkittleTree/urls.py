...
urlpatterns = patterns('',
                       ...
                       (r'^learn/?$', RedirectView.as_view(
                           url='/browse/homo/sapiens/hg19/chrY/?graphs=abn&start=1468365&scale=1&width=105#learn')),
                       (r'^card/?$', RedirectView.as_view(
                           url='/browse/businesscard/bcbanner/?graphs=abn&start=1&scale=1&width=296')),
)
